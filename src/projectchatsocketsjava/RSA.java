...
public class RSA {
    ...
    public static PrivateKey geteKey(String base64PrivateKey){
    ...
    public static String decryptRSA(String data, String base64PrivateKey) throws Exception {
        return decrypt(Base64.getDecoder().decode(data.getBytes()), geteKey(base64PrivateKey));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encryptedString = Base64.getEncoder().encodeToString(encryptRSA("rabab++ ", base64public));
